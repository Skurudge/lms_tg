...
INSTALLED_APPS = [
    ...
    # Сторонние пакеты
    "rest_framework",
    "corsheaders",  # Подключили CORS-заголовки (Критерий оценки)
    "rest_framework_simplejwt",
    "django_celery_beat",
    "drf_spectacular",  # Документация (Критерий оценки)

    # Наши будущие приложения
    "users",
    "habits",
]
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Бэкенд-сервис для трекинга полезных привычек по книге Джеймса Клира",
    "VERSION": "1.0.0",
...
CORS_ALLOW_ALL_ORIGINS = True  # Разрешаем запросы со всех доменов для фронтенда
